<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&height=280&color=0:05010F,30:0B132B,65:1C2541,100:00F5FF&text=DEV%20SINGH&fontColor=ffffff&fontSize=52&animation=fadeIn&fontAlignY=36&desc=DevOps%20Engineer%20%E2%80%A2%20Cloud%20Engineer%20%E2%80%A2%20Automation%20Engineer&descAlignY=58&descSize=16&descColor=00F5FF"/>
</p>
...
```yaml
┌── [ SYSTEM INFORMATION // DEVSINGH_OS_v1.0 ] ────────────────────────────┐
│                                                                         │
│  • Identity        : Dev Singh                                          │
...
|:---|:---|:---|
| **NovaPay — Zero Downtime CI/CD Pipeline** | `GitHub Actions` `Docker` `Kubernetes` `Trivy` | Built a zero-downtime CI/CD pipeline with automated build, test and deployment workflows, vulnerability scanning, and Kubernetes rolling updates. |
| **PaySecure — Multi-Region Disaster Recovery Architecture** | `AWS` `Multi-Region Architecture` | Designed an AWS multi-region DR architecture with replication strategy, failover workflow, business continuity planning, and disaster recovery runbooks. |
| **Security-Hardened Kubernetes Platform** | `Kubernetes` `RBAC` `Network Policies` `Trivy` `DevSecOps` | Secured Kubernetes workloads with RBAC and network policies, performed container vulnerability scanning with Trivy, and applied DevSecOps practices for production-ready workloads. |
